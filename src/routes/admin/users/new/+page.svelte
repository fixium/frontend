	...
	<div class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
		<div class="bg-white rounded-lg shadow-lg p-6 max-w-xs w-full text-center">
			...
			<p class="mb-4 text-sm">
				Solicitamos fotos del usuario para validar su identidad y proteger la seguridad de tu taller
				y de tus clientes. <br />Esta verificación nos ayuda a garantizar que solo personas
				autorizadas puedan realizar acciones importantes dentro del sistema.
			</p>
			<button
