...
<div class="main-container">
    <h1 class="text-3xl font-extrabold text-blue-700 dark:text-blue-300 mb-6 text-center tracking-tight">
    ...
    <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-8">
        {#if showActions}
            <div class="flex-1 flex flex-col md:flex-row md:items-end gap-4">
                <div>
                    <label for="ticket-select" class="block mb-2 font-medium text-gray-700 dark:text-gray-300">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr class="bg-gray-100">
                            <th class="px-4 py-2 text-left font-semibold text-gray-700"><i class="fa fa-hashtag mr-1"></i>ID</th>
                            <th class="px-4 py-2 text-left font-semibold text-gray-700"><i class="fa fa-ticket-alt mr-1"></i>N° Ticket</th>
                            <th class="px-4 py-2 text-left font-semibold text-gray-700"><i class="fa fa-user mr-1"></i>Email Tecnico</th>
                            <th class="px-4 py-2 text-left font-semibold text-gray-700"><i class="fa fa-calendar-plus mr-1"></i>Creado</th>
                            <th class="px-4 py-2 text-left font-semibold text-gray-700"><i class="fa fa-calendar-check mr-1"></i>Actualizado</th>
                            <th class="px-4 py-2 text-left font-semibold text-gray-700"><i class="fa fa-cogs mr-1"></i>Acciones</th>
                        </tr>
                    </thead>
