...
<div class="flex min-h-screen p-6">
	...
	<div class="w-full space-y-8">
		<section class=" shadow-lg rounded-lg p-6">
			<h2
				class="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2 text-black dark:text-white"
			>
			...
			<div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
				<button
					on:click={pairAndFetchInfo}
					class="bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 transition-all text-sm font-semibold shadow-md flex items-center justify-center gap-2 emparejar-btn"
				>
					<i class="fas fa-link"></i>
					Emparejar
				</button>
				<button
					on:click={() => call(unpairDevice, 'Desemparejando dispositivo...')}
					class="bg-red-600 text-white py-3 px-4 rounded-lg hover:bg-red-700 transition-all text-sm font-semibold shadow-md flex items-center justify-center gap-2 desemparejar-btn"
				>
					<i class="fas fa-unlink"></i>
					Desemparejar
				</button>
				<button
					on:click={() => call(restartDevice, 'Reiniciando dispositivo...')}
					class="bg-green-600 text-white py-3 px-4 rounded-lg hover:bg-green-700 transition-all text-sm font-semibold shadow-md flex items-center justify-center gap-2 reiniciar-btn"
				>
					<i class="fas fa-sync-alt"></i>
					Reiniciar
				</button>
				<button
					on:click={() => call(shutdownDevice, 'Apagando dispositivo...')}
					class="bg-yellow-600 text-white py-3 px-4 rounded-lg hover:bg-yellow-700 transition-all text-sm font-semibold shadow-md flex items-center justify-center gap-2 apagar-btn"
				>
					<i class="fas fa-power-off"></i>
					Apagar
				</button>
				<button
					on:click={() => call(activateDevice, 'Intentando activar dispositivo...')}
					class="bg-green-600 text-white py-3 px-4 rounded-lg hover:bg-green-700 transition-all text-sm font-semibold shadow-md flex items-center justify-center gap-2 activar-btn"
				>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-8">
			...
			<section class=" shadow-lg rounded-lg p-6">
				...
				<div class="flex gap-4">
					<button
						on:click={() => call(enterRecoveryMode, 'Entrando a modo recovery...')}
					...
					<button
						on:click={() => call(exitRecoveryMode, 'Saliendo de modo recovery...')}
	...
	<!-- Panel lateral -->
	<div
		class="hidden md:block ml-7 w-72 shadow-lg rounded-lg p-6 sticky top-6 max-h-[670px] overflow-y-auto overflow-x-hidden"
	>
		<h2
			class="text-l font-bold text-gray-800 mb-4 flex items-center gap-2 text-black dark:text-white"
		>
			<!-- Ícono móvil -->
		...
		{#if isPaired && deviceInfo}
			<div class="grid grid-cols-1 gap-4 text-sm text-gray-700">
				...
				<div class="space-y-1">
					<h3 class="text-xs font-semibold text-gray-500 uppercase mb-1 text-black dark:text-white">
						Datos principales
					</h3>
