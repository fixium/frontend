...
<div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
	<h1 class="text-3xl font-extrabold text-blue-700 mb-8 text-center tracking-tight dark:text-white">
			...
			<div class="flex flex-wrap gap-4 items-end flex-grow">
				<div>
					...
					<input
						...
						class="border rounded px-2 py-1 dark:bg-gray-800 dark:text-gray-300"
								...
								>
									...
									<td class="px-6 py-4 whitespace-nowrap flex justify-center gap-2">
										...
										<button
											...
											on:click={() => goto(`/technician/repairs?ticketId=${ticket.id}`)}
											type="button"
										>
											Reparaciones
										</button>
