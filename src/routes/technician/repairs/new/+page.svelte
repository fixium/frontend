<script>
	...
	async function handleSubmit() {
		...
		try {
			await createRepair(
				{ ticketId: Number(ticketId), diagnosis, repairActions },
				verificationImage
			);
...
<div class="form-container">
	...
	<form on:submit|preventDefault={handleSubmit} class="space-y-6">
			...
			<div class="flex flex-col items-center">
				...
				{#if imagePreview}
					<img
						...
						class="max-w-xs max-h-48 rounded mb-2 shadow"
		...
		<div class="flex justify-end">
			<button type="submit" class="form-btn flex items-center" disabled={loading}>
