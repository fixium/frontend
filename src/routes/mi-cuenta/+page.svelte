    ...
    <div class="w-full max-w-xl  rounded-2xl shadow-2xl p-10 border border-blue-100">
        ...
        {:else if user}
            ...
            {#if showChangePassword}
                ...
                >
                    <div>
                        <label for="current-password" class="block text-gray-700 mb-1 font-medium dark:text-gray-300 flex items-center gap-2"
                    ...
                    <div>
                        <label for="new-password" class="block text-gray-700 mb-1 font-medium dark:text-gray-300 flex items-center gap-2"
                    ...
                    <div>
                        <label for="confirm-password" class="block text-gray-700 mb-1 font-medium dark:text-gray-300 flex items-center gap-2"
