...
<div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
	<h1
		class="text-3xl font-extrabold text-blue-700 mb-8 text-center tracking-tight dark:text-blue-300"
	>
		...
		{#if existsTickets}
			<div class="flex flex-wrap gap-4 items-end flex-grow">
				<div>
					<label
						for="filtro-nombre"
						class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nombre cliente</label
					>
					<input
						id="filtro-nombre"
						type="text"
				...
				<div>
					<label
						for="filtro-ticket"
						class="block text-sm font-medium text-gray-700 dark:text-gray-300"># Ticket</label
					>
					<input
						id="filtro-ticket"
						type="text"
				...
				<div>
					<label
						for="filtro-imei"
						class="block text-sm font-medium text-gray-700 dark:text-gray-300">IMEI</label
					>
					<input
						id="filtro-imei"
						type="text"
				...
				<button
					...
					on:click={aplicarFiltro}>Filtrar</button
				>
				<button
					class="bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400"
					on:click={limpiarFiltro}>Limpiar</button
				>
			</div>
		{/if}
...
{#if showDetailModal && selectedTicket}
    <div class="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
        <div class="modal-content bg-white dark:bg-gray-800 dark:text-white rounded-lg shadow-lg p-6 max-w-3xl w-full relative">
            ...
            >&times;</button>
            <h2 class="text-xl font-bold mb-6 text-blue-700 dark:text-blue-300 text-center">Detalle del Ticket</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Columna izquierda -->
                <div class="flex flex-col gap-4">
                    <!-- Ticket -->
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 border border-gray-100 dark:border-gray-600">
                        <h3 class="font-semibold text-blue-700 dark:text-blue-300 mb-2">Ticket</h3>
                        ...
                        <div class="mb-1"><b>Recibido:</b> <span class="dark:text-white">{new Date(selectedTicket.receivedAt).toLocaleString()}</span></div>
                        <div class="mb-1"><b>Descripción inicial:</b> <span class="dark:text-white">{selectedTicket.initialStateDescription}</span></div>
                    </div>
                    <!-- Cliente -->
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 border border-gray-100 dark:border-gray-600">
                        <h3 class="font-semibold text-blue-700 dark:text-blue-300 mb-2">Cliente</h3>
                        <div class="mb-1"><b>Nombre:</b> <span class="dark:text-white">{selectedTicket.customer.name}</span></div>
                        <div class="mb-1"><b>Teléfono:</b> <span class="dark:text-white">{selectedTicket.customer.phone}</span></div>
                        <div class="mb-1"><b>Email:</b> <span class="dark:text-white">{selectedTicket.customer.email}</span></div>
                        <div class="mb-1"><b>Notas:</b> <span class="dark:text-white">{selectedTicket.customer.notes}</span></div>
                    </div>
                    <!-- Imágenes -->
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 border border-gray-100 dark:border-gray-600">
                        <h3 class="font-semibold text-blue-700 dark:text-blue-300 mb-2">Imágenes</h3>
                ...
                <div class="flex flex-col gap-4 mt-6 md:mt-0">
                    <!-- Creador del Ticket -->
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 border border-gray-100 dark:border-gray-600">
                        <h3 class="font-semibold text-blue-700 dark:text-blue-300 mb-2">Creador del Ticket</h3>
                        <div class="mb-1"><b>Nombre:</b> <span class="dark:text-white">{selectedTicket.ticketCreator?.name}</span></div>
                        <div class="mb-1"><b>Email:</b> <span class="dark:text-white">{selectedTicket.ticketCreator?.email}</span></div>
                    </div>
                    <!-- Técnico Asignado -->
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 border border-gray-100 dark:border-gray-600">
                        <h3 class="font-semibold text-blue-700 dark:text-blue-300 mb-2">Técnico Asignado</h3>
                        {#if selectedTicket.assignedTechnician}
                            ...
                            <div class="mb-1"><b>Email:</b> <span class="dark:text-white">{selectedTicket.assignedTechnician.username}</span></div>
                            <div class="mb-1"><b>Teléfono:</b> <span class="dark:text-white">{selectedTicket.assignedTechnician.phoneNumber}</span></div>
                            <div class="mb-1"><b>Asignado el:</b> <span class="dark:text-white">{new Date(selectedTicket.assignedTechnician.createdAt).toLocaleString()}</span></div>
                        {:else}
                    ...
                    <!-- Dispositivo -->
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 border border-gray-100 dark:border-gray-600">
                        <h3 class="font-semibold text-blue-700 dark:text-blue-300 mb-2">Dispositivo</h3>
                        ...
                        <div class="mb-1"><b>IMEI:</b> <span class="dark:text-white">{selectedTicket.device.imei}</span></div>
