...
>
	...
	<div class="mt-6">
		...
		{#if selectedTechnicianId}
			<div
				class="bg-blue-50 border border-blue-300 rounded-lg p-2 mt-2 animate-fade-in flex items-center justify-between dark:bg-gray-700"
			>
				...
				<button
					type="button"
					class="ml-2 text-xs text-blue-600 hover:underline dark:text-blue-300 flex items-center"
					on:click={resetTecnico}
				>
