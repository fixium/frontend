...
<div class="p-8 rounded-2xl shadow-xl bg-white max-w-lg mx-auto mt-8 border border-gray-100">
	...
	{#if error}
		...
		<ul class="text-xs text-gray-500 mb-4 text-center">
			<li>
				<i class="fa fa-info-circle mr-1"></i>Verifica que los archivos sean imágenes válidas.
			</li>
			<li>
				<i class="fa fa-info-circle mr-1"></i>El tamaño máximo permitido puede ser 5MB por imagen.
			</li>
			<li>
				<i class="fa fa-info-circle mr-1"></i>Intenta nuevamente o contacta al administrador si el
				problema persiste.
			</li>
		</ul>
	{/if}
